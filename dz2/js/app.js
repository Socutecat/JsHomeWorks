...
let discountSales = parseInt('15%');
let priceSales = parseInt('100$');
let propVariable = 'discount'


let res = priceSales - discountSales;
console.log(res);


if('discount' in item ) {
	item.priceWithDiscount = res;
	console.log(res);
}
else{
...
obj.price = 1000;
obj.currency = 'dollar';
obj.details = {model:'6s', color:'pink'};
...
// let a = null && 25;
console.log(null & 25);	// '0' запнулось на первой  лжи 
